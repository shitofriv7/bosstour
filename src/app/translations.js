    ...
    tours: {
      ...
      list: [
        ...
        { 
          ...
          highlights: ["Морская прогулка на яхте над затонувшим городом", "Древние наскальные гробницы Миры", "Храм Святого Николая", "Бассейн под открытым небом и бухты для купания"], 
