    ...
    tours: {
      ...
      list: [
        ...
        { 
          ...
          price: "€250", 
          duration: "4 Hours", 
          images: ["https://clickyourguide.com/wp-content/uploads/2025/05/Angel-01-Yacht-kemer-Antalya-3.jpg"], 
        ...
        { 
          slug: "green-canyon", 
          name: "Green Canyon Luxury Boat Safari", 
          price: "€50", 
          duration: "8 Hours", 
          images: ["https://greencanyontour.com.tr/asset/images/slide_1.jpg", "https://d25tea7qfcsjlw.cloudfront.net/22342/modul/554738/3a1a.jpg"], 
        ...
        { 
          slug: "istanbul-tour", 
          name: "Istanbul Express: Day Trip from Antalya", 
          price: "€195", 
          duration: "15 Hours", 
          images: ["https://substackcdn.com/image/fetch/$s_!-kWV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbfc7d062-6f8f-44d9-897e-caee03c8c0ad_4080x2644.jpeg", "https://images.trvl-media.com/place/178267/528fc850-021d-4d9e-a408-5ae238cb5810.jpg"], 
  ...
  tr: {
    ...
    tours: {
      ...
      list: [
        ...
        { 
          slug: "green-canyon", 
          name: "Green Kanyon Lüks Tekne Safarisi", 
          price: "€50", 
          duration: "8 Saat", 
          images: ["https://greencanyontour.com.tr/asset/images/slide_1.jpg", "https://d25tea7qfcsjlw.cloudfront.net/22342/modul/554738/3a1a.jpg"], 
        ...
        { 
          slug: "istanbul-tour", 
          name: "İstanbul Ekspresi: Antalya'dan Günübirlik Tur", 
          price: "€195", 
          duration: "15 Saat", 
          images: ["https://substackcdn.com/image/fetch/$s_!-kWV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbfc7d062-6f8f-44d9-897e-caee03c8c0ad_4080x2644.jpeg", "https://images.trvl-media.com/place/178267/528fc850-021d-4d9e-a408-5ae238cb5810.jpg"], 
  ...
  de: {
    ...
    tours: {
      ...
      list: [
        ...
        { 
          slug: "green-canyon", 
          name: "Green Canyon Luxus-Boots-Safari", 
          price: "€50", 
          duration: "8 Stunden", 
          images: ["https://greencanyontour.com.tr/asset/images/slide_1.jpg", "https://d25tea7qfcsjlw.cloudfront.net/22342/modul/554738/3a1a.jpg"], 
        ...
        { 
          slug: "istanbul-tour", 
          name: "Istanbul Express: Tagesausflug ab Antalya", 
          price: "€195", 
          duration: "15 Stunden", 
          images: ["https://substackcdn.com/image/fetch/$s_!-kWV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbfc7d062-6f8f-44d9-897e-caee03c8c0ad_4080x2644.jpeg", "https://images.trvl-media.com/place/178267/528fc850-021d-4d9e-a408-5ae238cb5810.jpg"], 
    ...
    whyUs: { title: "Warum Boss Tour?", items: [
      ...
      { title: "Erfahrene Guides", desc: "Lokales Wissen für die besten Touren." },
      { title: "24/7 Support", desc: "Wir sind immer für Sie da." }
    ]},
    modal: { book: "Jetzt buchen", confirm: "Bestätigt", confirmDesc: "Ihre Anfrage wurde empfangen.", name: "Name", hotel: "Hotel", roomNo: "Zimmernummer" }
  },
  ru: {
    nav: { home: "Главная", tours: "Туры", fleet: "Автопарк", transfer: "Трансфер", realEstate: "Недвижимость", about: "О нас", services: "Опыт" },
    hero: { title: "Приключения в Анталье ждут вас", subtitle: "Исследуйте бирюзовое побережье с Boss Tour. Премиальные туры и роскошные автомобили.", cta: "Аренда авто", cta2: "Посмотреть туры", explore: "ИССЛЕДОВАТЬ", cta3: "Трансфер" },
    fleet: { title: "Наш премиальный автопарк", subtitle: "Современные автомобили для любой поездки.", viewAll: "Весь автопарк", viewDetails: "Подробнее", bookNow: "Забронировать", cars: [
    ...
    transfer: { 
      ...
      list: [
        { 
          ...
          longDesc: "Ощутите максимальный комфорт с нашим стандартным VIP Mercedes Vito. Идеально подходит для небольших групп или семей, оснащен кожаными сиденьями и просторным салоном.",
        ...
        { 
          ...
          longDesc: "Наш Maybach Edition Vito переопределяет понятие роскоши. Сиденья с массажем, фоновая подсветка и мультимедийные системы высокого класса — он создан для тех, кто ищет лучшее.",
          highlights: ["Потолок 'Звездное небо'", "Сиденья с массажем и наклоном", "Аудиосистема премиум-класса", "Личная перегородка"],
          included: ["Холодное шампанское/напитки", "VIP-сопровождение", "Эксклюзивный консьерж", "Ультрабыстрый Wi-Fi"]
        }
      ] 
    },
    tours: {
      title: "Популярные Туры и Развлечения",
      subtitle: "Лучшее в Анталье и за ее пределами.",
      highlightsLabel: "Особенности",
      ...
      list: [
        { 
          ...
          included: ["VIP трансфер из отеля", "Профессиональный русский гид", "Комфортабельный автобус", "Вход на озеро Салда"] 
        },
        { 
          slug: "kekova", 
          name: "Кекова – Демре – Мира (Путешествие к древним цивилизациям)", 
          price: "€50", 
          duration: "11 Часов", 
          images: ["https://kekovatekneturu.com/wp-content/uploads/Simena-Grave-Tomb-Demre.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_PE7wwOiCWscwlqcEpg2A_pvpGnfmQROdLw&s", "https://gunluktur.net/wp-content/uploads/2021/12/tourbooking-turkey.jpeg"], 
          desc: "Путешествие к античным руинам и на родину Святого Николая.", 
          longDesc: "Этот тур создан для тех, кто хочет прикоснуться к загадкам древней Ликии. Мы начнем наш путь в городе Демре, где посетим храм Святого Николая Чудотворца — именно здесь жил и совершал свои чудеса прообраз Санта-Клауса. Вы увидите древние византийские фрески и саркофаг святого. Далее мы отправимся к античному городу Мира, знаменитому своими наскальными гробницами, искусно высеченными прямо в отвесных скалах. Жемчужина тура — морская прогулка на яхте к затонувшему городу Кекова. Вы увидите остатки домов, лестниц и стен города, ушедшего под воду 2000 лет назад. Во время круиза мы сделаем остановки для купания в живописных бухтах с прозрачной водой.",
          highlights: ["Прогулка на яхте к затонувшему городу", "Древние наскальные гробницы Миры", "Храм Святого Николая", "Купание в живописных и уединенных бухтах"], 
          included: ["Трансфер туда и обратно", "Русскоговорящий историк-гид", "Все входные билеты", "Страховка"] 
        },
        { 
          slug: "cappadocia", 
          ...
          longDesc: "Добро пожаловать в мир, который кажется декорацией к фантастическому фильму. Наш двухдневный тур позволит вам полностью погрузиться в магию Каппадокии. В первый день мы исследуем музей под открытым небом Гёреме с его уникальными скальными храмами и фресками Х века. Вы увидите знаменитые \"дымоходы фей\" в долине Пашабаг и спуститесь в многоуровневый подземный город, где когда-то скрывались первые христиане. Второй день начнется (по желанию) перед рассветом с самого зрелищного события — полета на воздушном шаре. Сотни ярких шаров в небе на фоне восходящего солнца — этот момент останется в вашей памяти навсегда. Также мы посетим крепость Учхисар для панорамного обзора всей долины. Вы провете ночь в аутентичном \"пещерном\" отеле, чтобы прочувствовать дух этого удивительного края.",
          highlights: ["Полет на воздушном шаре (опция)", "Музей Гёреме и скальные храмы", "Многоуровневый подземный город", "Долина Пашабаг", "Панорама крепости Учхисар"], 
          included: ["Проживание в пещерном или каменном отеле", "Опытный лицензированный гид", "VIP транспорт", "Экскурсионная программа"] 
        },
        { 
          slug: "lavanta-garden", 
        ...
        { 
          ...
          included: ["Трансфер на комфортабельном автобусе", "Профессиональный гид-историк", "Входные билеты в Аспендос"] 
        },
        { 
          slug: "city-tour", 
          ...
          highlights: ["Подъем на фуникулере к замку", "Экскурсия по крепости Аланьи", "Вид на пляж Клеопатры", "Панорамная площадка для фото"], 
          included: ["Трансфер из отеля и обратно", "Билеты на фуникулер", "Услуги русского гида"] 
        },
        { 
          slug: "mix-adventure", 
          ...
          included: ["Полное защитное снаряжение", "Профессиональные инструкторы", "Все трансферы", "Страховка"] 
        },
        { 
          slug: "rafting", 
          ...
          included: ["Шлем и спасательный жилет", "Место в лодке и весло", "Инструктор-капитан", "Трансфер"] 
        },
        { 
          slug: "jeep-safari", 
          ...
          highlights: ["Веселые водные битвы на джипах", "Офф-роуд в горах Торос", "Посещение турецкой деревни"], 
          included: ["Джип 4x4 с водителем", "Гид-аниматор", "Вход в сельский дом"] 
        },
        { 
          slug: "sapadere-canyon", 
          ...
          included: ["Трансфер туда и обратно", "Все входные билеты", "Услуги гида"] 
        },
        { 
          slug: "quad-safari", 
        ...
        { 
          slug: "zipline", 
          name: "Мега-комбо 5-в-1: Главное приключение Антальи", 
          price: "€75", 
          duration: "10 Часов", 
          images: ["https://tursaytravel.com/wp-content/uploads/2024/05/Alanya-Buggy-Rafting-Zipline-Tour-Tursay-Travel-13.webp", "https://www.schweitzer.com/-/media/schweitzer/summer-activities/schweitzer-zipline-1920x1080.jpg"], 
          desc: "Рафтинг, Зиплайн, Каньон Тазы, Квадроциклы и Багги — всё за один невероятный день!", 
          longDesc: "Зачем выбирать что-то одно, если можно получить всё? Это наш самый полный приключенческий пакет для настоящих любителей адреналина. Ваш день начнется с поездки через горы Торос к величественному каньону Тазы. После фотосессии на смотровой площадке \"Орлиное гнездо\" мы отправимся на 14-километровый рафтинг по горной реке. Но на этом приключения не заканчиваются — вы пролетите над каньоном на зиплайне, а затем сядете за руль квадроцикла или багги для лесного сафари.",
          highlights: ["Исследование каньона Тазы", "14 км рафтинга по горной реке", "Гигантский зиплайн над каньоном", "Офф-роуд сафари на квадроциклах/багги", "Приключение на природе"], 
          included: ["Все снаряжение для приключений", "Профессиональные гиды", "Трансфер из отеля и обратно"] 
        },
        { 
          slug: "paragliding", 
        ...
        { 
          ...
          longDesc: "Классический день в Средиземном море ждет вас! Наша стилизованная пиратская яхта выйдет из исторического порта Аланьи и пройдет вдоль Красной башни и старой верфи. Мы обогнем мыс с крепостью и посетим три главные пещеры: Пиратскую, Пещеру Влюбленных и Фосфорную, где вода светится изнутри. В течение дня мы сделаем несколько остановок в открытом море и уютных бухтах для купания. На борту команда аниматоров устроит игры, танцы и грандиозную пенную вечеринку на обратном пути. Идеальный отдых для всей семьи!",
          highlights: ["Круиз вдоль исторического порта", "Осмотр морских пещер", "Пенная вечеринка и анимация", "Купание в открытом море"], 
          included: ["Морская прогулка", "Анимация", "Трансфер"] 
        },
        { 
          slug: "fishing", 
        ...
        { 
          ...
          longDesc: "Приглашаем вас в мир восточной сказки. Шоу \"Турецкая ночь\" — это яркий спектакль, объединяющий традиции Османской империи и энергию современной Турции. Вы увидите мистический танец вращающихся дервишей, зажигательные народные танцы разных регионов и, конечно, виртуозный танец живота. Шоу интерактивно: вы сами сможете выйти на сцену и попробовать себя в восточных танцах. Почувствуйте гостеприимную душу Турции!",
          highlights: ["Шоу вращающихся дервишей", "Народные танцы и фольклор", "Профессиональный танец живота", "Интерактивная шоу-программа"], 
          included: ["Все шоу и выступления", "Трансфер обратно"] 
        },
        { 
          slug: "turkish-bath", 
          ...
          included: ["Все банные процедуры", "Пенный массаж", "20 мин масляного массажа", "Посещение всей спа-зоны", "Травяной чай", "Трансфер"] 
        },
        { 
          slug: "aquapark", 
          name: "Аквапарк и Отельный Люкс", 
          price: "€45", 
          duration: "Весь День", 
          images: ["https://www.aquafuncity.com/images/galeri/aqua1.jpg", "https://cdn.alanyatekmar.com/f48067f0-fc19-4515-8b5c-17b64703c6bf.jpg"], 
          desc: "Целый день на водных горках с обедом (шведский стол) в отеле и пивом/вином включено.", 
          longDesc: "Приготовьтесь к идеальному летнему дню! Наш пакет в Аквапарк предлагает больше, чем просто горки. Наслаждайтесь целым днем экстрима в лучшем аквапарке региона с более чем 20 горками и волновыми бассейнами. Но роскошь на этом не заканчивается — в пакет включен качественный обед (шведский стол) в нашем отеле-партнере, а также безлимитное пиво и вино для освежения. Это идеальное сочетание семейного отдыха и комфорта \"все включено\".",
          highlights: ["20+ скоростных горок", "Обед (шведский стол) в отеле", "Пиво и вино включено", "Гигантский волновой бассейн", "Доступ в отель на весь день"], 
          included: ["Входной билет", "Обед (шведский стол) в отеле", "Безлимитное пиво и вино", "Шезлонги и зонтики", "Трансфер из отеля"] 
        },
        { 
          slug: "dolphin-show", 
          ...
          duration: "3 Часа", 
          images: ["https://travelagencyapp-storage.s3.eu-central-1.amazonaws.com/sunnytour/407fa665-6440-402c-bc91-0668a2ad1a1e_f2fd438e-2a26-48c0-ba4a-a6fb6c3652b1_.webp", "https://cmsal.argeya.com/Content/CompanyFiles/SliderResimleri/57b10374eb10bb1a58dd1a71.jpg"], 
          desc: "Потрясающее шоу с самыми умными обитателями океана.", 
        ...
        { 
          slug: "horse-tour", 
          name: "Конное сафари по лесу и у реки", 
          price: "€40", 
          duration: "3 Часа", 
          images: ["https://tursaytravel.com/wp-content/uploads/2024/05/Alanya-Horse-Riding-Tour-Tursay-Travel-13.webp", "https://tursaytravel.com/wp-content/uploads/2024/05/Alanya-Horse-Riding-Tour-Tursay-Travel-1.webp", "https://sencaptour.com/wp-content/uploads/2023/06/Alanya-At-binme-turu-4.webp"], 
          desc: "Конная прогулка вдоль лесных и речных троп.", 
          longDesc: "Найдите гармонию с природой верхом на лошади. Наш маршрут проходит по живописным лесным и речным тропам. Наши лошади очень спокойные, обученные и подходят даже для детей и тех, кто никогда не сидел в седле. После короткого инструктажа и под присмотром опытных гидов вы отправитесь в путешествие. Аромат хвои, пение птиц и величие гор создают атмосферу полного уединения. Мы сделаем остановку для отдыха и фотографий.",
          highlights: ["Спокойные обученные лошади", "Живописный лесной и речной маршрут", "Виды на горы", "Обучение основам верховой езды", "Фотосессия на панорамных точках"], 
        ...
        { 
          ...
          longDesc: "Когда солнце начинает садиться, начинаются настоящие приключения. Наше ночное джип-сафари приглашает вас в горы Торос за новыми эмоциями. На открытых джипах 4x4 мы отправимся на панорамные площадки, чтобы увидеть закат над Аланьей и Средиземным морем. Прохладный горный воздух и мерцающие огни города внизу создают волшебную атмосферу. Это идеальный способ спастись от дневной жары и увидеть дикую сторону Аланьи ночью.",
          highlights: ["Закат в горах Торос", "Ночной офф-роуд на джипах", "Живая музыка и огненное шоу", "Панорамные виды под звездами"], 
          included: ["Трансфер из отеля и обратно", "Джип 4x4 с водителем", "Услуги гида", "Развлекательная программа"] 
        },
        { 
          slug: "land-of-legends", 
          ...
          longDesc: "Окунитесь в мир фантазии и приключений. The Land of Legends — это не просто парк аттракционов, это огромный развлекательный комплекс, включающий гигантский аквапарк (Kingdom of Sea) and парк приключений (Adventure Park). Бросьте вызов Hyper Coaster высотой 62 метра, испытайте Typhoon Coaster длиной 525 метров или расслабьтесь в волновом бассейне. В поарке также проходят потрясающие шоу дельфинов и белух. Вечером зона \"Château\" преображается: здесь проходит зрелищный лодочный парад и музыкальное световое шоу. Это приключение мирового уровня, сочетающее в себе драйв, водные забавы и магию для всей семьи.",
        ...
        { 
          ...
          longDesc: "Исследуйте скрытые сокровища Средиземного моря. Независимо от того, новичок вы или опытный дайвер, Аланья предлагает кристально чистую воду и разнообразную морскую жизнь. Наш тур начинается с подробного инструктажа по снаряжению и технике погружения от сертифицированных инструкторов PADI/CMAS. Мы отправимся на лодке к двум разным местам погружения, включая подводные пещеры и рифы. Вы поплаваете среди разноцветных рыб, осьминогов и, возможно, даже встретите морских черепах. Для новичков первое погружение — ознакомительное на небольшую глубину. Это незабываемый опыт в тишине глубокого синего моря.",
          highlights: ["Два разных места погружения", "Подводные системы пещер", "Профессиональные гиды PADI/CMAS", "Современное полное снаряжение", "Прогулка на катере"], 
          included: ["Профессиональное снаряжение", "Два погружения с гидом", "Страховка", "Трансфер из отеля"] 
        },
        { 
          slug: "antalya-aquarium", 
          name: "Анталья: Канатная дорога и Аквариум", 
          price: "€45", 
          duration: "8 Часов", 
          images: ["https://www.talyatur.com/images/tour/104912_b.jpg", "https://royalfuntour.com/media-uploads/Oceanarium-Antalya.jpg"], 
          desc: "Канатная дорога с панорамным видом и посещение одного из крупнейших аквариумов мира.", 
          longDesc: "Ощутите магию подводного мира в Аквариуме Антальи с самым большим в мире туннелем. Тур также включает посещение Калеичи (Старого города), водопадов Дюден и поездку на канатной дороге на гору Тюнектепе.",
          highlights: ["Самый большой в мире туннельный аквариум 131м", "Прогулка по Старому городу (Калеичи)", "Водопады Дюден", "Панорамная канатная дорога", "Тысячи морских обитателей"], 
          included: ["Трансфер из отеля и обратно", "Входной билет в Аквариум", "Билет на канатную дорогу", "Профессиональный гид"] 
        },
        { 
          slug: "green-canyon", 
          name: "Зеленый Каньон: Сафари на Яхте", 
          price: "€50", 
          duration: "8 Часов", 
          images: ["https://greencanyontour.com.tr/asset/images/slide_1.jpg", "https://d25tea7qfcsjlw.cloudfront.net/22342/modul/554738/3a1a.jpg"], 
          desc: "Отдохните на изумрудных водах водохранилища Оймапынар.", 
          longDesc: "Побег в сердце природы в Зеленом каньоне. Проплывите по изумрудным водам в окружении гор Торос. Исследуйте Большой и Малый каньоны, искупайтесь в освежающем озере.",
          highlights: ["Круиз по изумрудно-зеленым водам", "Купание в водохранилище Оймапынар", "Исследование Большого и Малого каньонов", "Потрясающие виды на горы Торос", "Неприкосновенная природа и дикая жизнь"], 
          included: ["Трансфер из отеля", "Морская прогулка", "Страховка"] 
        },
        { 
          slug: "istanbul-tour", 
          name: "Стамбул Экспресс: Дневной тур из Антальи", 
          price: "€195", 
          duration: "15 Часов", 
          images: ["https://substackcdn.com/image/fetch/$s_!-kWV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbfc7d062-6f8f-44d9-897e-caee03c8c0ad_4080x2644.jpeg", "https://images.trvl-media.com/place/178267/528fc850-021d-4d9e-a408-5ae238cb5810.jpg"], 
          desc: "Отправьтесь в город на двух континентах и посетите иконы мировой истории.", 
          longDesc: "Незабываемая поездка в Стамбул на самолете. Посетите Голубую мечеть, собор Святой Софии и дворец Топкапы. Насладитесь круизом по Босфору между Европой и Азией, посетите Египетский базар и вернитесь в Анталью вечерним рейсом.",
          highlights: ["Голубая мечеть и собор Святой Софии", "Экскурсия по дворцу Топкапы", "Круиз по Босфору (Европа и Азия)", "Ипподром и Египетский базар", "Полное VIP-управление днем"], 
          included: ["Билеты на самолет в обе стороны", "Все VIP-трансферы", "Профессиональный гид", "Все входные билеты в музеи"] 
        },
        { 
          slug: "alanya-all-in-one", 
          name: "Обзорная экскурсия по Аланье – Все в 1", 
          price: "€40", 
          duration: "8 часов", 
          images: ["https://www.besttimetravel.com.tr/public/uploads/0000/1/2026/04/04/copilot-20260404-113528.png"], 
          desc: "Проведите незабываемый день в обзорном туре по Аланье «Все в 1»: река Дим-Чай, пещера Дим, апельсиновые сады, водопад, аквапарк и морская прогулка с пенной вечеринкой!", 
          longDesc: "Приготовьтесь открыть для себя уникальные красоты Аланьи за один день! Этот тур — незабываемый опыт, в котором гармонично сочетаются природа, история, культура и развлечения. В сопровождении наших профессиональных и дружелюбных водителей мы заберем вас из отеля утром и отправимся по насыщенной программе к самым особенным местам Аланьи. Мы совершим путешествие к сердцу природы в прохладный рай реки Дим-Чай. Пока вы будете плавать в ледяной воде, окружающая вас зелень подарит умиротворение. Мы посетим пещеру Дим — одну из самых известных природных достопримечательностей Аланьи. Наш тур также предлагает культурное погружение: посетив исторический сельский дом, вы прикоснетесь к прошлому Аланьи, а визит в мечеть позволит ближе познакомиться с местной культурой и архитектурой. Вы прогуляетесь по апельсиновым садам среди ароматов цитрусовых, а затем насладитесь мелодией природы у прохладных вод небольшого водопада. В аквапарке на берегу реки Дим-Чай вас ждут веселые моменты на водных горках. Мы отправимся в 1-часовую частную прогулку на лодке по лазурному Средиземному морю, сделаем остановку для купания в открытом море и достигнем пика веселья на пенной вечеринке! 🎉",
          highlights: ["Смотровая площадка", "Купание в реке Дим-Чай и аквапарк", "Водные битвы", "Исследование пещеры Дим", "Посещение исторического сельского дома", "Мечеть и местная культура", "Прогулка по апельсиновому саду", "Малый водопад", "Вкусный обед", "1-часовая морская прогулка", "Купание в открытом море", "Пенная вечеринка"], 
          included: ["Комфортабельный транспорт", "Профессиональное сопровождение", "Вкусный обед", "Морская прогулка"] 
        }
      ]},
